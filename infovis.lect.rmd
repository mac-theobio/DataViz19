...
<div style="font-size: 18px">
    ...
    - "Where are the forums that take a boring and ugly statistical graphic and try to point out how to jazz it up a little?  ... Pick some boring statistical graphics and rip them to shreds; tell us what we are doing wrong and how to get better" (see ["take a sad plot and make it better"](https://apreshill.github.io/ohsu-biodatavis/slides.html#1))
...
- **pictographs** are OK  
they don't distract too much, may be good hooks
...
(see ["you can replicate almost any plot with R"](https://simplystatistics.org/2019/08/28/you-can-replicate-almost-any-plot-with-ggplot2/))
- can you show data without an opinion?

## misc refs

- FlowingData [best of 2018](https://flowingdata.com/2018/12/27/best-data-visualization-projects-of-2018/) (and more: [all posts tagged 'best of'](https://flowingdata.com/tag/best-of/))
