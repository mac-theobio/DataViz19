...
```{r vc1,warning=FALSE,message=FALSE}
...
anim_save("spatial_ex_files/ridings.gif")
```

![](spatial_ex_files/ridings.gif)

## dog licenses

NYC zip codes [here](https://data.cityofnewyork.us/widgets/i8iw-xf4u)

```{r get_dogs,message=FALSE}
zc <- read_sf("data/nyc_zipcodes")
Sys.setenv("VROOM_CONNECTION_SIZE" = 2^30)
dogs <- (data.table::fread("data/NYC_dogs.csv")
  %>% as_tibble()
