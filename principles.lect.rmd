...
## bag plot (2D boxplot) @rousseeuw_bagplot_1999

In `ggplot`:

```{r get_ggbag,message=FALSE,warning=FALSE}
...
ggplot(iris,
       aes(Sepal.Length,Sepal.Width,colour=Species,shape=Species,fill=Species))+
  geom_point()+
  geom_bag()
```
...
# William Cleveland: quantifying efficacy of graphics

![](pix/william_cleveland.jp){width=2in}
...
![](pix/Edward_Tufte_-_cropped.jpg){width=2in}
